...
-   **Technical Documentation:**
    1.  Place your technical documentation RAR file inside the `documents` folder.
    2.  **Important:** The bot is configured to send a file named `tech_docs_placeholder.rar`. You must rename your file to match this name, or update the file path in the `send_tech_documentation` function in `bot/bot_main.py`.

-   **Hardware Requirements:**
    1.  Place your two PDF files with hardware requirements into the `documents` folder.
    2.  **Important:** The bot is configured to send files named `hardware_req_1.pdf` and `hardware_req_2.pdf`. You must rename your files to match these names, or update the file paths in the `send_hardware_requirements` function in `bot/bot_main.py`.
